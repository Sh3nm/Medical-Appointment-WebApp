...
export default function ModalDialog({
  ...
  description = "Janji temu Anda berhasil dibuat. Silakan cek dashboard untuk melihat detail janji temu.",
  onDashboardClick,
  onUndoClick,
}: ModalDialogProps) {
            ...
            <div className="items-center gap-2 mt-3 text-sm sm:flex">
              <Dialog.Close asChild>
                <button
                  ...
                  className="w-full mt-2 p-2.5 flex-1 text-white bg-indigo-600 rounded-md outline-none ring-offset-2 ring-indigo-600 focus:ring-2 hover:bg-indigo-700"
                >
                  Dashboard
                </button>
              </Dialog.Close>
